...
avsa_boot <- mybootPX(fit = avsa_fit, px = 0.5, psi_max = 0.1, sims = 1000, seed = 123)
hovu_boot <- mybootPX(hovu_fit, px = 0.5, psi_max = 0.1, sims = 1000, seed = 123)
trae_boot <- mybootPX(trae_fit, px = 0.5, psi_max = 0.1, sims = 1000, seed = 123)
chga_boot <- mybootPX(chga_fit, px = 0.5, psi_max = 0.1, sims = 1000, seed = 123)
pegl_boot <- mybootPX(pegl_fit, px = 0.5, psi_max = 0.1, sims = 1000, seed = 123)
...
# fit the models
suppressWarnings({
for (ii in seq_along(unique(data_A$species))){
  subset(data_A, data_A$species == unique(data_A$species)[ii], select = c(1:ncol(data_A))) -> data_by_sp
...
best_model_marion <- sigmoidal_fits
best_model <- best_model_marion
