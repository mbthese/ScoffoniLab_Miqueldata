...
pval_from_R2_gaussian <- function(R2, n, k_full = 3, k_null = 1) {
  ...
  LR <- 2 * LR                # standard LR test statistic
...
Avsa_GEx_A_SI<-ggplot()+
 geom_point(data=data_avsa,aes(x=`Psileaf from RWC`,y=An.area),size=5,color="black", alpha = 0.3)+
 geom_line(aes(x = x_seq.avsa_A, y = y_model.avsa_A_sigmoidal), color = 'black', size=1.5)+
...
Hovu_GEx_A_SI<-ggplot()+
 geom_point(data=data_hovu,aes(x=`Psileaf from RWC`,y=An.area),size=5,color="black", alpha = 0.3)+
 geom_line(aes(x = x_seq.hovu_A, y = y_model.hovu_A_sigmoidal), color = 'black', size=1.5)+
...
Trae_GEx_A_SI<-ggplot()+
 geom_point(data=data_trae,aes(x=`Psileaf from RWC`,y=An.area),size=5,color="black", alpha = 0.3)+
 geom_line(aes(x = x_seq.trae_A, y = y_model.trae_A_sigmoidal), color = 'black', size=1.5)+
...
Pegl_GEx_A_SI<-ggplot()+
 geom_point(data=data_Pegl,aes(x=`Psileaf from RWC`,y=An.area),size=5,color="black", alpha = 0.3)+
 geom_line(aes(x = x_seq.Pegl_A, y = y_model.Pegl_A_sigmoidal), color = 'black', size=1.5)+
...
Chga_GEx_A_SI<-ggplot()+
 geom_point(data=data_chga,aes(x=`Psileaf from RWC`,y=An.area),size=5,color="black", alpha = 0.3)+
 geom_line(aes(x = x_seq.chga_A, y = y_model.chga_A_sigmoidal), color = 'black', size=1.5)+
...
Zema_GEx_A_SI<-ggplot()+
 geom_point(data=data_zema,aes(x=`Psileaf from RWC`,y=An.area),size=5,color="black", alpha = 0.3)+
 geom_line(aes(x = x_seq.zema_A, y = y_model.zema_A_sigmoidal), color = 'black', size=1.5)+
...
Avsa_GEx_g_SI<-ggplot()+
 geom_point(data=data_avsa,aes(x=`Psileaf from RWC`,y=gsw.area),size=5,color="black", alpha = 0.3)+
   geom_line(aes(x = x_seq.avsa, y = y_model.avsa_g_sigmoidal), color = 'black', size=1.5)+
...
Hovu_GEx_g_SI<-ggplot()+
 geom_point(data=data_hovu,aes(x=`Psileaf from RWC`,y=gsw.area),size=5,color="black", alpha = 0.3)+
   geom_line(aes(x = x_seq.hovu, y = y_model.hovu_g_sigmoidal), color = 'black', size=1.5)+
...
Trae_GEx_g_SI<-ggplot()+
 geom_point(data=data_trae,aes(x=`Psileaf from RWC`,y=gsw.area),size=5,color="black", alpha = 0.3)+
   geom_line(aes(x = x_seq.trae, y = y_model.trae_g_sigmoidal), color = 'black', size=1.5)+
...
Chga_GEx_g_SI<-ggplot()+
 geom_point(data=data_chga,aes(x=`Psileaf from RWC`,y=gsw.area),size=5,color="black", alpha = 0.3)+
   geom_line(aes(x = x_seq.chga, y = y_model.chga_g_sigmoidal), color = 'black', size=1.5)+
...
Pegl_GEx_g_SI<-ggplot()+
 geom_point(data=data_pegl,aes(x=`Psileaf from RWC`,y=gsw.area),size=5,color="black", alpha = 0.3)+
   geom_line(aes(x = x_seq.pegl, y = y_model.pegl_g_sigmoidal), color = 'black', size=1.5)+
...
Zema_GEx_g_SI<-ggplot()+
 geom_point(data=data_zema,aes(x=`Psileaf from RWC`,y=gsw.area),size=5,color="black", alpha = 0.3)+
   geom_line(aes(x = x_seq.zema, y = y_model.zema_g_sigmoidal), color = 'black', size=1.5)+
...
avsa_W_plot<-ggplot()+
 ...
 geom_line(aes(x = x_seq.avsa_W *(-1), y = y_model.avsa_W), color = '#56B4E9', size=3)+
  ...
  theme(axis.title.y=element_text(size=14),
        ...
        title = element_text(size=13, face = "bold.italic"))+
   ggtitle("A. sativa")+
   annotate("text", x = -2, y =200, label = expression(r^2 == 0.37), size = 5, fontface = "bold")+
  annotate("text", x = -2, y =170, label = expression(P < 0.001), size = 5, fontface = "bold")+
   ylab(expression(paste("WUE"[i])))+
  xlab(expression(paste(Psi["leaf"]," (MPa)")))+
  xlim(0,-3)
...
hovu_W_plot<-ggplot()+
 ...
 geom_line(aes(x = x_seq.hovu_W *(-1), y = y_model.hovu_W), color = '#56B4E9', size=3)+
  ...
  theme(axis.title.y=element_text(size=14),
        ...
        title = element_text(size=13, face = "bold.italic"))+
   ggtitle("H. vulgare")+
  annotate("text", x = -2, y =200, label = expression(r^2 == 0.21), size = 5, fontface = "bold")+
   annotate("text", x = -2, y =170, label = expression(P < 0.001), size = 5, fontface = "bold")+
   ylab(expression(paste("WUE"[i])))+
  xlab(expression(paste(Psi["leaf"]," (MPa)")))+
  xlim(0,-3)
...
trae_W_plot<-ggplot()+
 ...
 geom_line(aes(x = x_seq.trae_W *(-1), y = y_model.trae_W), color = '#56B4E9', size=2)+
  ...
  theme(axis.title.y=element_text(size=14),
        ...
        title = element_text(size=13, face = "bold.italic"))+
   ggtitle("T. aestivum")+
  annotate("text", x = -2, y =200, label = expression(r^2 == 0.16), size = 5, fontface = "bold")+
   annotate("text", x = -2, y =170, label = expression(P < 0.01), size = 5, fontface = "bold")+
   ylab(expression(paste("WUE"[i])))+
  xlab(expression(paste(Psi["leaf"]," (MPa)")))+
  xlim(0,-3)
trae_W_plot
...
chga_W_plot<-ggplot()+
 ...
 geom_line(aes(x = x_seq.chga_W *(-1), y = y_model.chga_W), color = '#E69F00', size=2)+
  ...
  theme(axis.title.y=element_text(size=14),
        ...
        title = element_text(size=13, face = "bold.italic"))+
   ggtitle("C. gayan")+
  annotate("text", x = -2, y =200, label = expression(r^2 == 0.61), size = 5, fontface = "bold")+
   annotate("text", x = -2, y =170, label = expression(P < 0.001), size = 5, fontface = "bold")+
   ylab(expression(paste("WUE"[i])))+
  xlab(expression(paste(Psi["leaf"]," (MPa)")))+
  xlim(0,-3)
...
pegl_W_plot<-ggplot()+
 ...
 geom_line(aes(x = x_seq.pegl_W *(-1), y = y_model.pegl_W), color = '#E69F00', size=2)+
  ...
  theme(axis.title.y=element_text(size=14),
        ...
        title = element_text(size=13, face = "bold.italic"))+
   ggtitle("P. glaucum")+
  annotate("text", x = -2, y =200, label = expression(r^2 == 0.53), size = 5, fontface = "bold")+
  annotate("text", x = -2, y =170, label = expression(P < 0.001), size = 5, fontface = "bold")+
   ylab(expression(paste("WUE"[i])))+
  xlab(expression(paste(Psi["leaf"]," (MPa)")))+
  xlim(0,-3)
...
zema_W_plot<-ggplot()+
 ...
 geom_line(aes(x = x_seq.zema_W *(-1), y = y_model.zema_W), color = '#E69F00', size=2)+
  ...
  theme(axis.title.y=element_text(size=14),
        ...
        title = element_text(size=13, face = "bold.italic"))+
   ggtitle("Z. mays")+
  annotate("text", x = -2, y =200, label = expression(r^2 == 0.22), size = 5, fontface = "bold")+
  annotate("text", x = -2, y =170, label = expression(P < 0.05), size = 5, fontface = "bold")+
   ylab(expression(paste("WUE"[i])))+
  xlab(expression(paste(Psi["leaf"]," (MPa)")))+
  xlim(0,-3)
zema_W_plot
...
Avsa_kleaf_SI<-ggplot()+
  geom_point(data=Kleaf_avsa,aes(x=`Lowest Psileaf`,y=`Kleaf Tcorr`),size=5,color="black", alpha = 0.3)+
   geom_line(aes(x = x_seq.avsa.kleaf, y = y_model.avsa_Kleaf), color = 'black', size=1.5)+
...
Hovu_kleaf_SI<-ggplot()+
  geom_point(data=Kleaf_hovu,aes(x=`Lowest Psileaf`,y=`Kleaf Tcorr`),size=5,color="black", alpha = 0.3)+
   geom_line(aes(x = (-1)*x_seq.hovu.kleaf, y = y_model.hovu_Kleaf), color = 'black', size=1.5)+
...
Trae_kleaf_SI<-ggplot()+
  geom_point(data=Kleaf_trae,aes(x=`Lowest Psileaf`,y=`Kleaf Tcorr`),size=5,color="black", alpha = 0.3)+
   geom_line(aes(x = x_seq.trae.kleaf, y = y_model.trae_Kleaf), color = 'black', size=1.5)+
...
Chga_kleaf_SI<-ggplot()+
  geom_point(data=Kleaf_chga,aes(x=`Lowest Psileaf`,y=`Kleaf Tcorr`),size=5,color="black", alpha = 0.3)+
   geom_line(aes(x = x_seq.chga.kleaf, y = y_model.chga_Kleaf), color = 'black', size=1.5)+
...
Pegl_kleaf_SI<-ggplot()+
  geom_point(data=Kleaf_pegl,aes(x=`Lowest Psileaf`,y=`Kleaf Tcorr`),size=5,color="black", alpha = 0.3)+
   geom_line(aes(x = x_seq.pegl.kleaf, y = y_model.pegl_Kleaf), color = 'black', size=1.5)+
...
Zema_kleaf_SI<-ggplot()+
  geom_point(data=Kleaf_zema,aes(x=`Lowest Psileaf`,y=`Kleaf Tcorr`),size=5,color="black", alpha = 0.3)+
   geom_line(aes(x = x_seq.zema.kleaf, y = y_model.zema_Kleaf), color = 'black', size=1.5)+
...
Avsa_kplant_SI<- ggplot()+
 geom_point(data=data_Kplant_avsa,aes(x=(-1)*`psi Licor (Mpa)`,y=Kplant*10^3),size=5,color="black", alpha = 0.3)+
  geom_line(aes(x =(-1)*x_seq.avsa.kplant, y = y.model.Kplant.avsa*10^3), color = 'black', size=1.5)+
...
hovu_kplant_SI<- ggplot()+
 geom_point(data=data_Kplant_hovu,aes(x=(-1)*`psi Licor (Mpa)`,y=Kplant*10^3),size=5,color="black", alpha = 0.3)+
  geom_line(aes(x =(-1)*x_seq.hovu.kplant, y = y.model.Kplant.hovu*10^3), color = 'black', size=1.5)+
...
trae_kplant_SI<- ggplot()+
 geom_point(data=data_Kplant_trae,aes(x=(-1)*`psi Licor (Mpa)`,y=Kplant*10^3),size=5,color="black", , alpha = 0.3)+
  geom_line(aes(x =(-1)*x_seq.trae.kplant, y = y.model.Kplant.trae*10^3), color = 'black', size=1.5)+
...
chga_kplant_SI<- ggplot()+
 geom_point(data=data_Kplant_chga,aes(x=(-1)*`psi Licor (Mpa)`,y=Kplant*10^3),size=5,color="black", alpha = 0.3)+
  geom_line(aes(x =(-1)*x_seq.chga.kplant, y = y.model.Kplant.chga*10^3), color = 'black', size=1.5)+
...
pegl_kplant_SI<- ggplot()+
 geom_point(data=data_Kplant_pegl,aes(x=(-1)*`psi Licor (Mpa)`,y=Kplant*10^3),size=5,color="black",alpha = 0.3)+
  geom_line(aes(x =(-1)*x_seq.pegl.kplant, y = y.model.Kplant.pegl*10^3), color = 'black', size=1.5)+
...
zema_kplant_SI<- ggplot()+
 geom_point(data=data_Kplant_zema,aes(x=(-1)*`psi Licor (Mpa)`,y=Kplant*10^3),size=5,color="black", alpha = 0.3)+
  geom_line(aes(x =(-1)*x_seq.zema.kplant, y = y.model.Kplant.zema*10^3), color = 'black', size=1.5)+
...
Avsa_kroot_SI<- ggplot()+
 geom_point(data=data_Kroot_avsa,aes(x=(-1)*`psi roots`,y=Kroot*10^3),size=5,color="black", alpha = 0.3)+
  geom_line(aes(x =(-1)*x_seq.avsa.kroot, y = y.model.Kroot.avsa*10^3), color = 'black', size=1.5)+
...
hovu_kroot_SI<- ggplot()+
 geom_point(data=data_Kroot_hovu,aes(x=(-1)*`psi roots`,y=Kroot*10^3),size=5,color="black", alpha = 0.3)+
  geom_line(aes(x =(-1)*x_seq.hovu.kroot, y = y.model.Kroot.hovu*10^3), color = 'black', size=1.5)+
...
trae_kroot_SI<- ggplot()+
 geom_point(data=data_Kroot_trae,aes(x=(-1)*`psi roots`,y=Kroot*10^3),size=5,color="black", alpha = 0.3)+
  geom_line(aes(x =(-1)*x_seq.trae.kroot, y = y.model.Kroot.trae*10^3), color = 'black', size=1.5)+
...
chga_kroot_SI<- ggplot()+
  geom_point(data=data_Kroot_chga,aes(x=(-1)*`psi roots`,y=Kroot*10^3),size=5,color="black", alpha = 0.3)+
  geom_line(aes(x =(-1)*x_seq.chga.kroot, y = y.model.Kroot.chga*10^3), color = 'black', size=1.5)+
...
pegl_kroot_SI<- ggplot()+
 geom_point(data=data_Kroot_pegl,aes(x=(-1)*`psi roots`,y=Kroot*10^3),size=5,color="black", alpha = 0.3)+
  geom_line(aes(x =(-1)*x_seq.pegl.kroot, y = y.model.Kroot.pegl*10^3), color = 'black', size=1.5)+
...
zema_kroot_SI<- ggplot()+
 geom_point(data=data_Kroot_zema,aes(x=(-1)*`psi roots`,y=Kroot*10^3),size=5,color="black", alpha = 0.3)+
  geom_line(aes(x =(-1)*x_seq.zema.kroot, y = y.model.Kroot.zema*10^3), color = 'black', size=1.5)+
...
units_tbl <- read_excel("C:/Users/mboisse/Dropbox/Mon PC (Jaboty20)/Post_doc_CalState_LA/Miquel_data/data/units.xlsx")  %>%   # adjust
  pivot_longer(
    everything(),
    names_to = "Trait",
    values_to = "Units"
...
df_final <- df_rounded_named %>%
  mutate(`t.test p-value` = ifelse(
    suppressWarnings(as.numeric(`t.test p-value`)) < 0.05,
    paste0("<b>", `t.test p-value`, "<b>"),
    as.character(`t.test p-value`)
  ))
...
df_final %>%
  ...
  column_spec(9, width = "7em", background = "azure2") %>%
  ...
  pack_rows("Hydraulic conductance", 7, 12) %>%
  pack_rows("PV traits", 13, 18)%>%
  pack_rows("Safety margins", 19, 21)%>%
  pack_rows("Embolism onset, rehydration capacity & photochemistry", 22, 24)%>%
  pack_rows("Anatomy and shrinkage", 25, 34)  %>%
  save_kable(file = "../results/Plot_info_summary6.png", zoom = 6)
```
...
trait_labels <- c(
  PKleaf50   = expression(italic(P)[Kleaf50]),
  PKroot50   = expression(italic(P)[Kroot50]),
  PKplant50  = expression(italic(P)[Kplant50]),
  osp.tlp    = expression(pi[tlp]),
  PWUEimax   = expression(italic(P)[WUEi-max]),
  Pgs50      = expression(italic(P)[gs50]),
  PA50       = expression(italic(P)[A50]),
  PPLNCF50     = expression(italic(P)[PLNCF50]),
  `Embolism onset` = "Embolism onset",
  PPLRC50       = expression(italic(P)[PLRC50]),
  PLA25      = expression(italic(P)[LA25]),
  PLT25      = expression(italic(P)[LT25]),
  PLW25      = expression(italic(P)[LW25]))
...
Figure6 <- ggplot(events_long, aes(x = mean, y = trait, color = Metabolism)) +
  ...
  scale_color_manual(values = c("C3" = "steelblue", "C4" = "goldenrod")) +
