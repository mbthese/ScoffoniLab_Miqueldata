...
# === MAIN EXECUTION ===
input_file <- "../results/fvfm/FVFM_recovery_curve_PLNCF.csv"
output_dir <- "../results/PLNCF/"
...
write.csv(all_results, file.path(output_dir, "model_fitting_results_PLNCF.csv"), row.names = FALSE)
